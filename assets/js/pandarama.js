...
//PROD
let assetAddress = '0xAEB3e641Ec85517A63604CB13FCE73BA22FcC827'
let assetSymbol = 'wTFC';
let minAmount = 2100000000000000000000;
let assetDecimals = 18;
let stakeAddress = '0xD86Da92b4b310EE485C4a9092B0BFf631b14a7A4'
let assetChain = 137;
...
async function performStake() {
    ...
    console.log('stake WEI: ' + stakeAmountWei.toString() + ' selectedAccount: ' + selectedAccount);
    Loader.open();
    ...
    stakeFirst.methods.stakeTokens(selectedAccount, ''+stakeAmountWei, 12).send({from: selectedAccount, gasPrice: '60000000000', gasLimit: 400000})
        ...
        stakeFirst.methods.hasStake(selectedAccount).call({from: selectedAccount})
            .then(function (has) {
                ...
                if (hasStake) {
                    ...
                    document.querySelector("#turnover_claim").style.display = "block";
                    document.querySelector("#turnover_claim").innerHTML = 'Turnover claim disabled';
                    $('#turnover_claim').attr('disabled', true);
