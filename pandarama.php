        ...
        <section class="home-intro-wrap" style="background-image: url('assets/img/temp/home-banner-bg.jpg');">
            <div class="home-intro gen-width gen-rim white-font">
                <div class="home-intro-inner">
                    <div class="home-intro__text" style="margin-top: 10px;padding-top: 40px;">
                        <img src="assets/img/logo-pandatoken.png" alt="Logo PandaToken" width="110">
                        <br>
                        <br>
                        <h1><span class="gen-font-gradient">Pandarama</span></h1>
                        <p>wTFC Staking Pool (open until 250,000 wTFC is staked)</p>
                        <p>Minimum stake amount: 2100 wTFC</p>
                        <p>Staking Period: 1 year</p>
                        <p>Staking Bonus: 40% (released at end of year)</p>
                        <p>Pandarama 1.25% Turnover Bonus: paid weekly after Pandarama app is live</p>
                        <p>Loan: After Pandarama app is live, you can borrow weekly against your staked amount, up to 50% in total</p>
                        <br>
                        <p>Pandarama app will be live on Android May 15th, 2022</p>
<!--                        <br>-->
                    ...
                    <div class="home-intro__text2" style="margin-top: 20px;">
                        ...
                        <div id="wallet_connected" style="display: none;">
                            ...
                            <div id="has_no_stake" style="display: none;">
                                <p>Stake amount (min 2100 wTFC)</p>
                            ...
                            <div id="has_stake" style="display: none;">
                                ...
                                <button id="turnover_claim" class="btn-main" style="display: none;margin: 20px auto auto;">
                                    Borrow
                                </button>

                                <p style="margin-top: 20px;">Turnover claims and borrowing will be enabled when the Pandarama app is live</p>
